...
export default function UserFormModal({ isOpen, onClose, onSubmit, initialData }: UserFormModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Validation for new users no longer requires password as it's generated by backend
        /* 
        ...
        */
        ...
        // Clean up password if empty (to avoid sending empty string to backend)
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                Contraseña <span className="text-xs text-gray-500 font-normal">(Opcional)</span>
                            </label>
                            <input
                                type="password"
