          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <HighchartsChart
                ...
                type="column"
                title={
                  tipoVista === 'TOTAL X CÍA' ? 'Comparativa R12 - 202406 vs 202506' :
                  tipoVista === 'TOTAL X CANAL' ? 'Comparativa R12 por Canal - 202406 vs 202506' :
                  tipoVista === 'CAS X CANAL' ? 'Comparativa R12 CAS por Canal - 202406 vs 202506' :
                  tipoVista === 'CAS X RAMO' ? 'Comparativa R12 CAS por Ramo - 202406 vs 202506' :
                  tipoVista === 'ASSA X CANAL' ? 'Comparativa R12 ASSA por Canal - 202406 vs 202506' :
                  tipoVista === 'ASSA X RAMO' ? 'Comparativa R12 ASSA por Ramo - 202406 vs 202506' :
                  tipoVista === 'ASSA X CÍA' ? 'Comparativa R12 ASSA por Compañía - 202406 vs 202506' :
                  tipoVista === 'ART X CANAL' ? 'Comparativa R12 ART por Canal - 202406 vs 202506' :
                  tipoVista === 'ART X CÍA' ? 'Comparativa R12 ART por Compañía - 202406 vs 202506' :
              ...
              <HighchartsChart
                ...
                type="pie"
                title={
                  tipoVista === 'TOTAL X CÍA' ? 'Distribución Q PÓL 202506' :
                  tipoVista === 'TOTAL X CANAL' ? 'Distribución Q PÓL por Canal 202506' :
                  tipoVista === 'CAS X CANAL' ? 'Distribución Q PÓL CAS por Canal 202506' :
                  tipoVista === 'CAS X RAMO' ? 'Distribución Q PÓL CAS por Ramo 202506' :
                  tipoVista === 'ASSA X CANAL' ? 'Distribución Q PÓL ASSA por Canal 202506' :
                  tipoVista === 'ASSA X RAMO' ? 'Distribución Q PÓL ASSA por Ramo 202506' :
                  tipoVista === 'ASSA X CÍA' ? 'Distribución Q PÓL ASSA por Compañía 202506' :
                  tipoVista === 'ART X CANAL' ? 'Distribución Q PÓL ART por Canal 202506' :
                  tipoVista === 'ART X CÍA' ? 'Distribución Q PÓL ART por Compañía 202506' :
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
              <HighchartsChart
                ...
                type="line"
                title={
                  tipoVista === 'TOTAL X CÍA' ? 'Evolución R12 - 202406 vs 202506' :
                  tipoVista === 'TOTAL X CANAL' ? 'Evolución R12 por Canal - 202406 vs 202506' :
                  tipoVista === 'CAS X CANAL' ? 'Evolución R12 CAS por Canal - 202406 vs 202506' :
                  tipoVista === 'CAS X RAMO' ? 'Evolución R12 CAS por Ramo - 202406 vs 202506' :
                  tipoVista === 'ASSA X CANAL' ? 'Evolución R12 ASSA por Canal - 202406 vs 202506' :
                  tipoVista === 'ASSA X RAMO' ? 'Evolución R12 ASSA por Ramo - 202406 vs 202506' :
                  tipoVista === 'ASSA X CÍA' ? 'Evolución R12 ASSA por Compañía - 202406 vs 202506' :
                  tipoVista === 'ART X CANAL' ? 'Evolución R12 ART por Canal - 202406 vs 202506' :
                  tipoVista === 'ART X CÍA' ? 'Evolución R12 ART por Compañía - 202406 vs 202506' :
