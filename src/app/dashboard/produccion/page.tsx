...
export default function Produccion() {
  ...
  const chart2Data = {
    ...
    series: [
      { name: 'CAS', data: [1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200, 2300], color: '#567caa' },
      { name: 'ASSA', data: [1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100], color: '#4ebeb0' },
      { name: 'ART', data: [800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900], color: '#fa9426' },
    ],
    credits: { enabled: false },
    legend: { enabled: true },
  };
